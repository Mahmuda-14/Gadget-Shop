    ...
    return (
        <div className="sm:ml-[70px] lg:ml-0 " >
            <div className="items-center text-center m-9 " >
                ...
                <h2 className=" sm:-ml-[134px] lg:ml-0 text-4xl font-mono font-semibold" data-aos="fade-right">Our Top Brands</h2>
            ...
            <div className="grid sm:grid-cols-1 lg:grid-cols-6 justify-between gap-11 mx-20 my-20 " >
